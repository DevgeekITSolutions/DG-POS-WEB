<?php session_start();
  ...
  if(!isset($_SESSION["clientpanel"])) {
    ...
    }  elseif(isset($_GET['customreport'])) {
        include("customreport.php");

    }  elseif(isset($_GET['ejournal'])) {
        include("ejournal.php");
...
<script type="text/javascript">
  ...
  function contactus() {
    window.open('mailto:devgeekitsolutions@gmail.com?subject=subject&body=body');
  }
  function profile() {
