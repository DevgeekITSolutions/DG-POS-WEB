...
<script type="text/javascript">
  ...
  function ApxChart2(btnid) {
    ...
    loadGrossSellingStore(btnid,dateval,storeid)

  }

  function loadGrossSellingStore(btnid,date,storeid){
    ...
    $("#gross_sales").DataTable({
      ...
      searching: false,
      "bDestroy": true,
      "ajax": {url:'dtserver/getsales.php?btnid='+btnid+'&dateval='+date+'&storeid='+storeid,dataSrc:""},
      "columns": [
            {
          "data": "Name",
        },
