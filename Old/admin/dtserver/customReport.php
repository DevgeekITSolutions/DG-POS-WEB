...
$sql = "SELECT a.*,b.store_name,c.discount_type FROM posrev.admin_daily_transaction_details a 
...
while($row = mysqli_fetch_array($result)){
    ...
    $report_arr[] = array("id" => $row['details_id'],"store_name" => $row['store_name'], "name" => $row['product_name'], 
                        ...
                        ,'price'=>$row['price'],'total'=>$row['total'],'discount_type'=>$row['discount_type'],'date'=>$row['zreading']);
}
