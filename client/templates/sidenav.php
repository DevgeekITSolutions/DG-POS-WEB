    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="?customreport" class="nav-link <?= ($_SERVER['REQUEST_URI']=="/client/?customreport")?"active":"";?>">
          ...
          <li class="nav-item">
            <a href="?ejournal" class="nav-link <?= ($_SERVER['REQUEST_URI']=="/client/?ejournal")?"active":"";?>">
              <i class="nav-icon fas fa-journal-whills"></i>
              <p>
                EJournal
              </p>
          ...
          <li class="nav-item">
            <a href="?faqs"class="nav-link <?= ($_SERVER['REQUEST_URI']=="/client/?faqs")?"active":"";?>">
          ...
          <li class="nav-item">
            <a href="?help" class="nav-link <?= ($_SERVER['REQUEST_URI']=="/client/?help")?"active":"";?>">
